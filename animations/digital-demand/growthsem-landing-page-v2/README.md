...
1.  Ensure you have a modern web browser that supports ES Modules.
2.  Serve the root directory using a static file server (e.g., VS Code Live Server, Python's `http.server`, or `npx serve`).
3.  Open `index.html` in your browser.

The application uses an import map to load dependencies directly from a CDN, so no `npm install` or build step is strictly required for previewing the static prototype.
