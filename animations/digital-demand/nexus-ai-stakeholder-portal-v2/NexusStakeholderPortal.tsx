        ...
        <header className="h-14 border-b border-white/10 bg-white/5 backdrop-blur-md px-5 flex items-center justify-between z-20 shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="size-8 rounded-full bg-gradient-to-tr from-primary to-accent-purple p-[1.5px]">
              <div className="w-full h-full rounded-full bg-background-dark overflow-hidden">
                <img alt="User" className="w-full h-full object-cover" src="https://picsum.photos/seed/nexus-user/100/100" />
              </div>
            </div>
          </div>
        </header>
          ...
          <div className="col-span-5 flex flex-col gap-4">
            ...
            <div className="glass-card rounded-xl p-3 flex items-center justify-between">
               <div className="flex -space-x-2">
                 {[1,2,3].map(i => (
                   <img key={i} className="size-6 rounded-full border border-white/10" src={`https://picsum.photos/seed/user-${i}/50/50`} />
                 ))}
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    {milestone.comment && (
                      <div className="mt-2 bg-white/5 rounded-lg p-2 border border-white/5 flex gap-2">
                        <img className="size-5 rounded-full" src={milestone.comment.avatar} />
