...
To run this application, you will need a modern web browser and a valid Google Gemini API key.

1.  **Set API Key**: Make sure your Google Gemini API key is available as an environment variable named `API_KEY`. The application will automatically use this key.
2.  **Open in Browser**: Simply open the `index.html` file in your preferred web browser.
3.  **View Dashboard**: The dashboard will load and display real-time mock data and AI-generated insights.
