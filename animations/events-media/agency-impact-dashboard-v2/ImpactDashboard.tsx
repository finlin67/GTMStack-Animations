          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <img 
                ...
                className="size-10 rounded-full border border-white/10 shadow-xl"
                alt="Profile"
              />
            </div>
          </div>
                        ...
                        >
                          <td className="px-8 py-5">
                            <div className="flex items-center gap-4">
                              <img src={advocate.img} className="size-10 rounded-full border border-white/10" alt={advocate.name} />
                              <div>
