...
const COLORS = [
  'bg-slate-800', // Darkest
  'bg-slate-700',
  'bg-slate-600',
  'bg-slate-500',
  'bg-blue-900',  // Accent
  'bg-indigo-900', // Accent
  'bg-slate-800',
];
...
export default function GTMStackHero() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-slate-100 p-8">
      ...
      >
          ...
          {modules.map((module, i) => {
            ...
            return (
              <motion.div
                ...
                className={`absolute flex items-center justify-center shadow-lg ${module.color} text-white border border-white/20`}
              >
                ...
                <div className="relative w-full h-full flex items-center px-4 overflow-hidden">
                  ...
                  >
                     <Icon size={isStack ? 18 : 20} className="text-white/90" />
                  </motion.div>
                  ...
                  <motion.span
                    ...
                    className="text-sm font-medium whitespace-nowrap tracking-wide text-slate-100"
                  >
                    {module.label}
                  </motion.span>
        ...
        <div className="absolute top-12 left-0 right-0 z-30 text-center pointer-events-none">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 text-slate-500 font-medium">
               <motion.span 
                 animate={{ 
                    color: phase === AnimationPhase.ROUTES ? '#6366f1' : '#64748b',
               ...
               <motion.span
                 animate={{ 
                    color: phase === AnimationPhase.STACK ? '#0f172a' : '#64748b',
        ...
        <div className="absolute bottom-8 left-0 right-0 flex justify-center gap-2 z-30">
            {[AnimationPhase.CHAOS, AnimationPhase.ROUTES, AnimationPhase.STACK].map((p, i) => (
                <motion.div
                    key={p}
                    className={`h-1.5 rounded-full ${phase === p ? 'bg-slate-800' : 'bg-slate-200'}`}
