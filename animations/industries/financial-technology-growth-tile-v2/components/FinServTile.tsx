...
const COLORS = {
  ...
  emerald: "#10b981",
  blue: "#60a5fa",
  dark: "#0f172a", // Updated to new Navy base
  slate900: "#0f172a",
};
    ...
    <div className="relative w-full h-full max-w-[600px] max-h-[600px] aspect-square mx-auto perspective-1000">
      ...
      <div className="relative w-full h-full">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none">
          <div className="relative flex items-center justify-center">
            ...
            <motion.div
              ...
              className="absolute size-[300px] sm:size-[420px] md:size-[520px] rounded-full border border-slate-700/30"
            />
            {/* Inner Ring */}
            <motion.div
              initial={{ scale: 0.9, opacity: 0 }}
              ...
              className="absolute size-[220px] sm:size-[300px] md:size-[380px] rounded-full border border-slate-600/20"
            />
            
            {/* Central Hub Node - Background lighted to slate-800 to pop against new Navy BG */}
            <motion.div
              animate={{
                boxShadow: [
              ...
              className="size-32 sm:size-48 rounded-full bg-slate-800 border-2 border-[#0b8aad]/40 flex flex-col items-center justify-center relative z-20 overflow-hidden"
            >
        ...
        <FloatingCard
          ...
          className="bottom-[15%] right-[0%] sm:right-[10%] bg-slate-800/40 border-slate-700/40"
          floatDuration={5.5}
          floatDelay={1.5}
        >
        ...
        <FloatingElement
          ...
          delay={0.9}
        >
          <div className="size-12 rounded-full border-2 border-[#10b981] p-1 bg-slate-800 shadow-lg shadow-[#10b981]/10">
            <img
        ...
        <FloatingElement
          ...
          floatDuration={4}
        >
          <div className="size-10 rounded-full border-2 border-[#60a5fa] p-1 bg-slate-800">
            <img
...
function FloatingCard({
  ...
  return (
    <motion.div
      ...
      // Updated default background to slate-800/60 for better contrast on Navy background
      className={`absolute z-20 bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-5 shadow-2xl ${className}`}
      {...props}
    >
        <motion.div
            animate={{ y: [0, -10, 0] }}
