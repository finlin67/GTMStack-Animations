...
// Color definitions matched to the original design
const COLORS = {
  primary: "#1e56f1", // Blue
...
export default function PubSecTile() {
  return (
    /* 
      Strict 600x600 container. 
      The parent in App.tsx handles scaling (transform: scale(...)) for responsiveness.
    */
    <div className="relative w-[600px] h-[600px] flex-shrink-0 bg-[#101522] rounded-3xl border border-[#1e56f1]/20 overflow-hidden shadow-2xl font-sans select-none">
