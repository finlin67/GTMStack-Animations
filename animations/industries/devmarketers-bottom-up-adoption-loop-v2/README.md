...
This project is set up as a simple static application that can be run with any local web server.

1.  Ensure you have Node.js and npm (or a similar package manager) installed.
2.  Open your terminal in the project's root directory.
3.  Install a simple server package if you don't have one:
    ```bash
    npm install -g serve
    ```
4.  Run the server:
    ...
    serve .
    ```
5.  Open your web browser and navigate to the local address provided by the server (usually `http://localhost:3000`).
