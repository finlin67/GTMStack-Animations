...
## Tech Stack
- React 19
- Tailwind CSS (v4 compatible via CDN)
- Framer Motion
- Lucide React

## Usage
1. Open `index.html` in any modern web browser.
2. Refresh the page to randomly switch between the Light and Dark High-Fidelity themes.
3. Observe the smooth surface transitions, elevation shadows, and backdrop-blur effects.