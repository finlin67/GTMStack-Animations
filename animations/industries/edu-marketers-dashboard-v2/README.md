...
## Usage
1.  **View the Dashboard:** Open the `index.html` file in any modern web browser that supports ESM modules.
2.  **Monitor Metrics:** Observe the real-time "jitter" in growth, satisfaction, and adoption metrics which simulate live data feeds.
3.  **Generate Strategy:** Click the **Strategy** button in the header to trigger the AI-powered insight engine, which provides a 3-step growth directive based on current market conditions.
4.  **Track the Funnel:** Review the "Market Funnel Performance" section to visualize the progress of various marketing and procurement stages.
